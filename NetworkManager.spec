...
Version  : 1.10.2
Release  : 29
URL      : https://download.gnome.org/sources/NetworkManager/1.10/NetworkManager-1.10.2.tar.xz
Source0  : https://download.gnome.org/sources/NetworkManager/1.10/NetworkManager-1.10.2.tar.xz
...
%prep
%setup -q -n NetworkManager-1.10.2
%patch1 -p1
%patch2 -p1
%patch3 -p1
pushd ..
cp -a NetworkManager-1.10.2 build32
popd
...
export LANG=C
export SOURCE_DATE_EPOCH=1513086097
export AR=gcc-ar
