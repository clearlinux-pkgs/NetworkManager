...
Source0  : https://download.gnome.org/sources/NetworkManager/1.8/NetworkManager-1.8.2.tar.xz
...
%prep
%setup -q -n NetworkManager-1.8.2
%patch1 -p1
%patch2 -p1
%patch3 -p1
pushd ..
cp -a NetworkManager-1.8.2 build32
popd
...
export LANG=C
export SOURCE_DATE_EPOCH=1505324282
export AR=gcc-ar
