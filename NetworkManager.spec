...
%prep
%setup -q -n NetworkManager-1.14.4
%patch1 -p1
%patch2 -p1
%patch3 -p1
%patch4 -p1
...
export LANG=C
export SOURCE_DATE_EPOCH=1545245761
export AR=gcc-ar
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/NetworkManager/1.14.4/libnm-device-plugin-adsl.so
/usr/lib64/NetworkManager/1.14.4/libnm-device-plugin-bluetooth.so
/usr/lib64/NetworkManager/1.14.4/libnm-device-plugin-wifi.so
/usr/lib64/NetworkManager/1.14.4/libnm-device-plugin-wwan.so
/usr/lib64/NetworkManager/1.14.4/libnm-ppp-plugin.so
/usr/lib64/NetworkManager/1.14.4/libnm-wwan.so
...
%files lib32
%defattr(-,root,root,-)
/usr/lib32/NetworkManager/1.14.4/libnm-device-plugin-adsl.so
/usr/lib32/NetworkManager/1.14.4/libnm-device-plugin-bluetooth.so
/usr/lib32/NetworkManager/1.14.4/libnm-device-plugin-wifi.so
/usr/lib32/NetworkManager/1.14.4/libnm-device-plugin-wwan.so
/usr/lib32/NetworkManager/1.14.4/libnm-wwan.so
