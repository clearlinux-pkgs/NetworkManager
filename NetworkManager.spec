...
Source0  : https://download.gnome.org/sources/NetworkManager/1.40/NetworkManager-1.40.10.tar.xz
...
%prep
%setup -q -n NetworkManager-1.40.10
cd %{_builddir}/NetworkManager-1.40.10
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1673452232
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/NetworkManager/1.40.10/libnm-device-plugin-adsl.so
/usr/lib64/NetworkManager/1.40.10/libnm-device-plugin-bluetooth.so
/usr/lib64/NetworkManager/1.40.10/libnm-device-plugin-wifi.so
/usr/lib64/NetworkManager/1.40.10/libnm-device-plugin-wwan.so
/usr/lib64/NetworkManager/1.40.10/libnm-ppp-plugin.so
/usr/lib64/NetworkManager/1.40.10/libnm-wwan.so
