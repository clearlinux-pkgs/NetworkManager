...
Version  : 1.40.8
Release  : 89
URL      : https://download.gnome.org/sources/NetworkManager/1.40/NetworkManager-1.40.8.tar.xz
Source0  : https://download.gnome.org/sources/NetworkManager/1.40/NetworkManager-1.40.8.tar.xz
...
%prep
%setup -q -n NetworkManager-1.40.8
cd %{_builddir}/NetworkManager-1.40.8
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1671486670
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/NetworkManager/1.40.8/libnm-device-plugin-adsl.so
/usr/lib64/NetworkManager/1.40.8/libnm-device-plugin-bluetooth.so
/usr/lib64/NetworkManager/1.40.8/libnm-device-plugin-wifi.so
/usr/lib64/NetworkManager/1.40.8/libnm-device-plugin-wwan.so
/usr/lib64/NetworkManager/1.40.8/libnm-ppp-plugin.so
/usr/lib64/NetworkManager/1.40.8/libnm-wwan.so
