...
%prep
%setup -q -n NetworkManager-1.42.2
cd %{_builddir}/NetworkManager-1.42.2
%patch1 -p1
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/NetworkManager/1.42.2/libnm-device-plugin-adsl.so
/usr/lib64/NetworkManager/1.42.2/libnm-device-plugin-bluetooth.so
/usr/lib64/NetworkManager/1.42.2/libnm-device-plugin-wifi.so
/usr/lib64/NetworkManager/1.42.2/libnm-device-plugin-wwan.so
/usr/lib64/NetworkManager/1.42.2/libnm-ppp-plugin.so
/usr/lib64/NetworkManager/1.42.2/libnm-wwan.so
