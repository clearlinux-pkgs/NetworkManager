...
Source0  : https://download.gnome.org/sources/NetworkManager/1.38/NetworkManager-1.38.0.tar.xz
...
%prep
%setup -q -n NetworkManager-1.38.0
cd %{_builddir}/NetworkManager-1.38.0
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1653425182
...
cp %{_builddir}/NetworkManager-1.38.0/COPYING %{buildroot}/usr/share/package-licenses/NetworkManager/4cc77b90af91e615a64ae04893fdffa7939db84c
cp %{_builddir}/NetworkManager-1.38.0/COPYING.GFDL %{buildroot}/usr/share/package-licenses/NetworkManager/7205ad2e7451e9c4a518d105d5144987cdaf9bfa
cp %{_builddir}/NetworkManager-1.38.0/COPYING.LGPL %{buildroot}/usr/share/package-licenses/NetworkManager/01a6b4bf79aca9b556822601186afab86e8c4fbf
%make_install
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/NetworkManager/1.38.0/libnm-device-plugin-adsl.so
/usr/lib64/NetworkManager/1.38.0/libnm-device-plugin-bluetooth.so
/usr/lib64/NetworkManager/1.38.0/libnm-device-plugin-wifi.so
/usr/lib64/NetworkManager/1.38.0/libnm-device-plugin-wwan.so
/usr/lib64/NetworkManager/1.38.0/libnm-ppp-plugin.so
/usr/lib64/NetworkManager/1.38.0/libnm-wwan.so
