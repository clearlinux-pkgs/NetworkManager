...
Source0  : https://download.gnome.org/sources/NetworkManager/1.10/NetworkManager-1.10.4.tar.xz
...
%prep
%setup -q -n NetworkManager-1.10.4
%patch1 -p1
%patch2 -p1
%patch3 -p1
pushd ..
cp -a NetworkManager-1.10.4 build32
popd
...
export LANG=C
export SOURCE_DATE_EPOCH=1517847346
export AR=gcc-ar
