...
%prep
%setup -q -n NetworkManager-1.40.0
cd %{_builddir}/NetworkManager-1.40.0
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1664928610
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/NetworkManager/1.40.0/libnm-device-plugin-adsl.so
/usr/lib64/NetworkManager/1.40.0/libnm-device-plugin-bluetooth.so
/usr/lib64/NetworkManager/1.40.0/libnm-device-plugin-wifi.so
/usr/lib64/NetworkManager/1.40.0/libnm-device-plugin-wwan.so
/usr/lib64/NetworkManager/1.40.0/libnm-ppp-plugin.so
/usr/lib64/NetworkManager/1.40.0/libnm-wwan.so
