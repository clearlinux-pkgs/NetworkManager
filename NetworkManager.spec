...
Version  : 1.38.4
Release  : 80
URL      : https://download.gnome.org/sources/NetworkManager/1.38/NetworkManager-1.38.4.tar.xz
Source0  : https://download.gnome.org/sources/NetworkManager/1.38/NetworkManager-1.38.4.tar.xz
...
%prep
%setup -q -n NetworkManager-1.38.4
cd %{_builddir}/NetworkManager-1.38.4
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1660236170
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/NetworkManager/1.38.4/libnm-device-plugin-adsl.so
/usr/lib64/NetworkManager/1.38.4/libnm-device-plugin-bluetooth.so
/usr/lib64/NetworkManager/1.38.4/libnm-device-plugin-wifi.so
/usr/lib64/NetworkManager/1.38.4/libnm-device-plugin-wwan.so
/usr/lib64/NetworkManager/1.38.4/libnm-ppp-plugin.so
/usr/lib64/NetworkManager/1.38.4/libnm-wwan.so
