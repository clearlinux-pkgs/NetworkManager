...
%prep
%setup -q -n NetworkManager-1.12.2
%patch1 -p1
%patch2 -p1
%patch3 -p1
pushd ..
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/NetworkManager/1.12.2/libnm-device-plugin-adsl.so
/usr/lib64/NetworkManager/1.12.2/libnm-device-plugin-bluetooth.so
/usr/lib64/NetworkManager/1.12.2/libnm-device-plugin-wifi.so
/usr/lib64/NetworkManager/1.12.2/libnm-device-plugin-wwan.so
/usr/lib64/NetworkManager/1.12.2/libnm-settings-plugin-ibft.so
/usr/lib64/NetworkManager/1.12.2/libnm-wwan.so
...
%files lib32
%defattr(-,root,root,-)
/usr/lib32/NetworkManager/1.12.2/libnm-device-plugin-adsl.so
/usr/lib32/NetworkManager/1.12.2/libnm-device-plugin-bluetooth.so
/usr/lib32/NetworkManager/1.12.2/libnm-device-plugin-wifi.so
/usr/lib32/NetworkManager/1.12.2/libnm-device-plugin-wwan.so
/usr/lib32/NetworkManager/1.12.2/libnm-settings-plugin-ibft.so
/usr/lib32/NetworkManager/1.12.2/libnm-wwan.so
